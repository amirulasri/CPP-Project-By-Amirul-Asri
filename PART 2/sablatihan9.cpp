...
int calculate_Total5( double discount, double h,int g)
{
    discount = (h/100);
    cout<<"Total tickets = "<<g<<"-"<<discount<< "="<<endl;
    return discount;
}
...
{
    int a,b,c,d,e,f,g;
    double first,secound,third,four,totalTicket,discount,h,i;
    cout.setf(ios::fixed);
    cout.precision(2);
    a = masukNombor1();
    ...
    h = masukDiscount();
    i = calculate_Total5(discount,h,g);
